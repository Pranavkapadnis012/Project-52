...
if(balloon.isTouching(topObstaclesGroup)||balloon.isTouching(topGround)||balloon.isTouching(bottomObstaclesGroup)||balloon.isTouching(bottomGround));
{
...
restart.visible = false
 ...
 bottomObstaclesGround.destroyEach();
